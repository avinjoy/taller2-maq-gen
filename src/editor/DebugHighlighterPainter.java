...
class DebugHighlighterPainter extends LayeredHighlighter.LayerPainter {

    private final String comment;
    
    public DebugHighlighterPainter(Color color, String c) {
    ...
    public Shape paintLayer(Graphics g, int p0, int p1, Shape viewBounds, JTextComponent editor, View view) {
        try {
            ...
            Logger.getLogger(DebugHighlighterPainter.class.getName()).log(Level.SEVERE, null, ex);
        }
