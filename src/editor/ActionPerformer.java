...
public class ActionPerformer {
     ...
     *
     * Le permite al usuario elegir un archivo para cargar en el área de
     * edición.
     */
     ...
     *
     * Busca un texto especificado por el usuario en el documento actual. El
     * texto queda guardado para búsquedas siguientes.
     */
     ...
     *
     * Posiciona el cursor en el inicio de una línea especificada por el
     * usuario.
     */
     ...
     *
     * Le permite al usuario elegir la fuente para la letra en el área de
     * edición.
     */
     ...
     *
     * Le permite al usuario elegir el color para la letra en el área de
     * edición.
     */
    ...
    /**
     * Retorna la instancia de un JFileChooser, con el cual se muestra un
     * dialogo que permite seleccionar un archivo.
     *
    ...
    /**
     * Clase anónima interna que extiende la clase
     * javax.swing.filechooser.FileFilter para establecer un filtro de archivos
     * en el JFileChooser.
     */
